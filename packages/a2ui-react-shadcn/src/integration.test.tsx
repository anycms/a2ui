...
import { shadcnReactComponents } from './registry';
...
/** Render a surface with the shadcn registry — proves the registry drives the
 *  same surface semantics as the vanilla default registry. */
function renderShadcn(surface: ReturnType<MessageProcessor['model']['get']>) {
  return render(<A2uiSurface surface={surface!} registry={shadcnReactComponents} />);
}
